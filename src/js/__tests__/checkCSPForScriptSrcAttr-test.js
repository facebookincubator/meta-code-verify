...
import {
  checkCSPForScriptSrcAttr as checkParsedCSPForScriptSrcAttr,
...
function checkCSPForScriptSrcAttr(cspHeaders) {
  return checkParsedCSPForScriptSrcAttr(parseCSPHeaders(cspHeaders));
}
