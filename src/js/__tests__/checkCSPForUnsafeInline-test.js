...
import {checkCSPForUnsafeInline as checkParsedCSPForUnsafeInline} from '../content/checkDocumentCSPHeaders';
...
function checkCSPForUnsafeInline(cspHeaders) {
  return checkParsedCSPForUnsafeInline(parseCSPHeaders(cspHeaders));
}
